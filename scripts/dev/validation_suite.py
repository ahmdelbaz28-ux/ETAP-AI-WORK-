...
class ValidationSuite:
    ...
    def validate_short_circuit(self):
        ...
        If_lg = abs(  # S117 engineering-notation variable names (e.g. Iarc, delta_V); snake_case would harm domain readability
    ...
    def validate_ybus(self):
        ...
        Ybus = system.build_ybus(  # S117 engineering-notation variable names (e.g. Iarc, delta_V); snake_case would harm domain readability
            seq="1"
        )  # NOSONAR physics/engineering notation (I=current, V=voltage, P/Q=power, Ybus/Zbus matrices); snake_case would harm domain readability
