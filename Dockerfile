...
# Full engineering service with Redis, Celery, OpenTelemetry, etc.
# For HuggingFace Spaces, use Dockerfile.hf-space instead.
# =============================================================================
...
# Pin pnpm to v9 — pnpm 11.x requires Node 22+
