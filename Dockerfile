...
COPY --chown=user:user contingency/ /app/contingency/
COPY --chown=user:user motor_starting/ /app/motor_starting/
...
COPY --chown=user:user visualization/ /app/visualization/
COPY --chown=user:user reporting/ /app/reporting/
COPY --chown=user:user digital_twin/ /app/digital_twin/
