...
class TestWLSEstimator:
    ...
    def test_check_redundancy_sufficient(self):
        # Need redundancy >= 1.5: with n=3, need m >= 8 for 2*3-1=5 states  # NOSONAR physics/engineering notation (I=current, V=voltage, P/Q=power, Ybus/Zbus matrices); snake_case would harm domain readability
        measurements = {
