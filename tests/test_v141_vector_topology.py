...
class TestTopologyGraphService:
    ...
    def test_add_connection_in_memory_fallback(self):
        ...
        service.add_element(
            NetworkElement(element_id="BUS-001", element_type=ElementType.BUS, name="Bus 1")
        )
        service.add_element(
            NetworkElement(element_id="BUS-002", element_type=ElementType.BUS, name="Bus 2")
        )
    ...
    def test_impact_analysis_in_memory(self):
        ...
        service.add_element(
            NetworkElement(element_id="BUS-001", element_type=ElementType.BUS, name="Main Bus")
        )
        service.add_element(
            NetworkElement(
