...
class TestSparseSolver:
    ...
    def test_power_balance_3bus(self):
        ...
        if result.converged:
            ...
            # NOSONAR: Power balance: generation - load ≈ losses  # — physics/engineering notation (I=current, V=voltage, P/Q=power, Ybus/Zbus matrices); snake_case would harm domain readability
