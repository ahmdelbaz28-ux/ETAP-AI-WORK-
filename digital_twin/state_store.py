...
class StateStore:
    ...
    def diff(self, version_a: int, version_b: int) -> dict[str, Any] | None:  # NOSONAR: cognitive complexity; scheduled for refactoring sprint (extract helpers / early returns)
        """
