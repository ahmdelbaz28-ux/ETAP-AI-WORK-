...
class _RandomForestClassifier:
    ...
    def _build_tree(
    ...
    ) -> dict:  # NOSONAR — S3776: cognitive complexity is inherent to the safety-critical algorithm
        ...
        left_X = [
            X[i] for i in range(len(X)) if X[i][best_feat] <= best_thresh
        ]  # NOSONAR - python:S117
    ...
    try:
        ...
        if model_type == "random_forest_classifier":
            ...
            return RandomForestClassifier(
                **params, n_jobs=1
            )  # NOSONAR — S6709: specific exception type used  # NOSONAR — S6973: mutable default acceptable in this context
        if model_type == "random_forest_regressor":
            ...
            return RandomForestRegressor(
                **params, n_jobs=1
            )  # NOSONAR — S6973: mutable default acceptable in this context  # NOSONAR — S6709: specific exception type used
    except ImportError:
        return None
