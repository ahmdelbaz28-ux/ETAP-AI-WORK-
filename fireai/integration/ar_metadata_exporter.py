...
class ARMetadataExporter:
    ...
    def _detector_to_node(
        self, det_id: str, det_state: Any
    ) -> (
        ARSceneNode
    ...
    def _build_binary_buffer(
        self, _snapshot: ARSnapshot
    ) -> bytes:  # NOSONAR — S1172: parameter retained for API stability
        """
