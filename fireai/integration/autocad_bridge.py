    ...
    def parse(
        ...
        while i < len(lines):
            ...
            if code == 0:
                ...
                if (
                    self._current_entity is not None
                ):  # NOSONAR — S1066: nested if kept for readability
...
class AutoCADBridge:
    ...
    def export_dxf(
        self, design: DesignData, path: str
    ...
    def _parse_dxf_ezdxf(
        ...
        try:
            ...
            try:
                ...
                logger.exception("ezdxf parsing failed: %s", exc)
                return {}
