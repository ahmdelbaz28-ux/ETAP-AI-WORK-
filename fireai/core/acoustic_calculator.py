...
def calculate_spl_at_distance(
    ...
    | None = None,  # NOSONAR — S1172: accepted for API stability; room volume flows here for reverberant-field SPL calculations
    ...
    direct_attenuation_dB = 20.0 * math.log10(
        target_distance_m / ref_distance_m
    )  # NOSONAR - python:S117
