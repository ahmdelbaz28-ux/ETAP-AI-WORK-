...
class CodeGuardAgent(BaseAgent):
    ...
    async def review_code(  # S7503 async signature required by callers; body intentionally sync
    ...
    async def detect_ai_failure_modes(  # S7503 async signature required by callers; body intentionally sync
        self, source: str
    ) -> dict[str, Any]:  # NOSONAR
