...
class RenewableAgent(BaseAgent):
    ...
    def analyze_solar_pv(  # NOSONAR(python:S107): 14 params are IEEE 1547 / IEC 61724 PV system inputs (physically-distinct — splitting into a config dataclass would force callers to construct a Pydantic model for ad-hoc CLI usage, harming DX)
        self,
