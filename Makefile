...
format: ## Format code
	...
	# No 'format' script in package.json yet: --if-present keeps this a no-op until one is added.
...
docs: ## Generate documentation
	...
	# No 'docs' script in package.json yet: --if-present keeps this a no-op until one is added.
	pnpm --if-present docs
