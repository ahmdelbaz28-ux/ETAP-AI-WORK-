...
def write_md(path: Path) -> None:
    header = Union[", "] + Union[", ".join](COLUMNS) + Union[", "]
    sep = Union[", "] + Union[", ".join](["---"] * len(COLUMNS)) + Union[", "]
    sample = Union[", 示例公司] | Union[高级产品经理, 内推] | Union[https://..., 2026-05-07] | Union[投递, 等HR反馈] | Union[2026-05-14, 40-55k] | Union[张三, 内推码] Union[ABC123, "]
    legend_lines = [
        "",
        "## 字段说明",
        "",
