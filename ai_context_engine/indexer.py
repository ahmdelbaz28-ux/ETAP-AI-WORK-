...
try:
    import tree_sitter  # noqa: F401  (used to verify availability; actual API used via Language/Parser below)
    import tree_sitter_python  # noqa: F401  (registers the Python grammar)
