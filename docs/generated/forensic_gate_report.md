...
## 9. سياسة --admin (Admin Policy)

- **القاعدة الحاكمة:** لا يُستخدم خيار `--admin` في عمليات الدمج إطلاقاً إلا بموافقة كتابية صريحة ومسبقة من المالك لكل PR على حدة.
- **المرجع التقني:** وجود هذا الخيار في سير عمل التحديث التلقائي (`.github/workflows/dependabot-auto-merge.yml:140`) هو استثناء مؤتمت خاص بحزم التبعيات المعزولة ولا يُعمم بأي حال من الأحوال على الدمج اليدوي أو طلبات السحب الوظيفية.
