...
class MultiLevelRecovery:
    ...
    def recover(self, error: BaseException, context: Optional[Any] = None) -> RecoveryResult:  # NOSONAR: cognitive complexity; scheduled for refactoring sprint (extract helpers / early returns)
