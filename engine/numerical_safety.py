...
class MatrixStabilizer:
    ...
    def safe_solve(
        self, a: np.ndarray, b: np.ndarray, _method: str = "lu"  # NOSONAR: S117 engineering-notation variable names (e.g. Iarc, delta_V); snake_case would harm domain readability
