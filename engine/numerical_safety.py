...
class NumericalGuard:
    ...
    def is_within_bounds(self, value: float | np.ndarray, min_val: float, max_val: float, _name: str = "value") -> bool:  # NOSONAR(S1172): param kept for API symmetry with clamp_to_bounds
