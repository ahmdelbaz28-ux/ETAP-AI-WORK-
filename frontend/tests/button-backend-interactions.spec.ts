 ...
 */
async function makeApiRequest(page: Page, endpoint: string, options: RequestInit = {}) {
  ...
  try {
    ...
    const response = await page.evaluate(async ({ endpoint, options, defaultHeaders }) => {
    ...
    }, { endpoint, options: { ...options, headers: defaultHeaders }, defaultHeaders });
...
test.describe('Dashboard Page Button Tests', () => {
  test('should test dashboard refresh button', async ({ page }) => {
    ...
    const refreshButton = page.locator('button[data-testid="refresh-stats"], button:has-text("Refresh"), button:has-text("Update")');
  ...
  test('should test dashboard quick action buttons', async ({ page }) => {
    ...
    for (const button of actionButtons) {
      if (await button.count() > 0) {
        const buttonName = await button.textContent() || 'Quick Action Button';
...
test.describe('Projects Page Button Tests', () => {
  test('should test create project button', async ({ page }) => {
    ...
    const createButton = page.locator('button:has-text("New Project"), button:has-text("Create Project"), button[data-testid="create-project-btn"]');
    ...
    if (await createButton.count() > 0) {
      ...
      const modal = page.locator('div[role="dialog"], div.modal, form[data-testid="project-form"]');
  ...
  test('should test project action buttons', async ({ page }) => {
    ...
    const actionButtons = page.locator('button:has-text("Edit"), button:has-text("Delete"), button:has-text("View"), button[data-testid="project-actions"]');
    
    if (await actionButtons.count() > 0) {
      const count = await actionButtons.count();
      
      for (let i = 0; i < Math.min(count, 3); i++) { // Test first 3 buttons to avoid too many requests
        const button = actionButtons.nth(i);
        const buttonText = await button.textContent() || `Project Action Button ${i}`;
...
test.describe('AutoCAD Page Button Tests', () => {
  test('should test AutoCAD connect button', async ({ page }) => {
    ...
    const connectButton = page.locator('button:has-text("Connect"), button:has-text("Connect to AutoCAD"), button[data-testid="connect-autocad-btn"]');
  ...
  test('should test AutoCAD upload button', async ({ page }) => {
    ...
    const uploadButton = page.locator('button:has-text("Upload"), button:has-text("Import DWG"), button[data-testid="upload-dwg-btn"]');
  ...
  test('should test AutoCAD draw/create buttons', async ({ page }) => {
    ...
    const drawButtons = [
      page.locator('button:has-text("Line"), button:has-text("Circle"), button:has-text("Rectangle"), button[data-testid="draw-shape-btn"]'),
      page.locator('button:has-text("Create"), button:has-text("Add Entity"), button[data-testid="create-entity-btn"]')
    ];
    ...
    for (const buttonGroup of drawButtons) {
      if (await buttonGroup.count() > 0) {
        ...
        for (let i = 0; i < Math.min(count, 2); i++) { // Test first 2 buttons
...
test.describe('Revit Page Button Tests', () => {
  test('should test Revit connect button', async ({ page }) => {
    ...
    const connectButton = page.locator('button:has-text("Connect"), button:has-text("Connect to Revit"), button[data-testid="connect-revit-btn"]');
  ...
  test('should test Revit upload button', async ({ page }) => {
    ...
    const uploadButton = page.locator('button:has-text("Upload"), button:has-text("Import RVT"), button[data-testid="upload-rvt-btn"]');
  ...
  test('should test Revit element creation buttons', async ({ page }) => {
    ...
    const createButtons = page.locator('button:has-text("Create"), button:has-text("Add"), button[data-testid="create-element-btn"]');
...
test.describe('Digital Twin Page Button Tests', () => {
  test('should test digital twin conversion button', async ({ page }) => {
    ...
    const convertButton = page.locator('button:has-text("Convert"), button:has-text("Start Conversion"), button[data-testid="convert-btn"]');
  ...
  test('should test digital twin configuration buttons', async ({ page }) => {
    ...
    const configButtons = page.locator('button:has-text("Save"), button:has-text("Apply"), button:has-text("Reset"), button[data-testid="config-action-btn"]');
...
test.describe('Elements Page Button Tests', () => {
  test('should test elements filter buttons', async ({ page }) => {
    ...
    const filterButtons = page.locator('button:has-text("Filter"), button:has-text("Search"), button:has-text("Clear"), button[data-testid="filter-btn"]');
  ...
  test('should test elements action buttons', async ({ page }) => {
    ...
    const actionButtons = page.locator('button:has-text("Edit"), button:has-text("Delete"), button:has-text("Duplicate"), button[data-testid="element-action"]');
...
test.describe('Connections Page Button Tests', () => {
  test('should test connections create button', async ({ page }) => {
    ...
    const createButton = page.locator('button:has-text("New Connection"), button:has-text("Create Connection"), button[data-testid="create-connection-btn"]');
  ...
  test('should test connections action buttons', async ({ page }) => {
    ...
    const actionButtons = page.locator('button:has-text("Validate"), button:has-text("Test"), button:has-text("Sync"), button[data-testid="connection-action"]');
...
test.describe('Conflicts Page Button Tests', () => {
  test('should test conflicts resolve button', async ({ page }) => {
    ...
    const resolveButton = page.locator('button:has-text("Resolve"), button:has-text("Fix Conflicts"), button[data-testid="resolve-conflicts-btn"]');
  ...
  test('should test conflicts check button', async ({ page }) => {
    ...
    const checkButton = page.locator('button:has-text("Check"), button:has-text("Detect Conflicts"), button[data-testid="check-conflicts-btn"]');
...
test.describe('Reports Page Button Tests', () => {
  test('should test reports generate button', async ({ page }) => {
    ...
    const generateButton = page.locator('button:has-text("Generate"), button:has-text("Create Report"), button[data-testid="generate-report-btn"]');
  ...
  test('should test reports export buttons', async ({ page }) => {
    ...
    // Test export buttons
    const exportButtons = page.locator('button:has-text("Export"), button:has-text("Download"), button:has-text("PDF"), button:has-text("Excel"), button[data-testid*="export"]');
...
test.describe('Settings Page Button Tests', () => {
  test('should test settings save button', async ({ page }) => {
    ...
    const saveButton = page.locator('button:has-text("Save"), button:has-text("Save Settings"), button[type="submit"]');
  ...
  test('should test CAD settings connection test buttons', async ({ page }) => {
    ...
    const testButtons = page.locator('button:has-text("Test Connection"), button:has-text("Verify"), button[data-testid*="test-connection"]');
