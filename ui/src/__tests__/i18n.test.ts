...
describe('i18n translations', () => {
  ...
  it('has critical navigation keys in both locales', () => {
    const requiredSidebarKeys = [
      'dashboard', 'studies', 'assistant', 'settings', 'administration', 'diagnostics',
    ]
  ...
  it('has study type keys in both locales', () => {
    const studyTypeKeys = [
      'load_flow', 'short_circuit', 'arc_flash', 'harmonic_analysis',
      'protection_coordination', 'motor_starting', 'transient_stability',
    ]
