          ...
          <div className="px-4 pb-3 space-y-2">
            ...
            {warnings.map((warning) => {
              ...
              return (
                <div
                  key={warning.id}
                  className={cn("p-2.5 rounded-lg border", config.bg, config.border)}
                >
            ...
            {actions.map((action) => {
              const actionClass = (() => {
                if (action.variant === "primary")
                  return "bg-[var(--accent-primary)]/10 text-[var(--accent-primary)] hover:bg-[var(--accent-primary)]/20";
                if (action.variant === "ghost")
                  return "text-[var(--text-secondary)] hover:bg-[var(--bg-elevated)]";
