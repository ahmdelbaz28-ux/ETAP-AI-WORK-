...
const ERROR_HELP_MAP: Record<string, HelpMapping> = {
  backend_unavailable: {
    ...
    description:
      'The engineering service is not responding. This usually means the Python backend is not running or the connection was refused.',
  ...
  auth_failed: {
    ...
    description:
      'Your credentials were rejected. Your session may have expired or the API key is invalid.',
    actions: [
  ...
  project_not_found: {
    ...
    description:
      'The requested project does not exist or has been deleted. It may have been removed by another user.',
    actions: [
  ...
  report_generation_failed: {
    ...
    description:
      'The report could not be generated. This may be due to missing study results or a template error.',
    actions: [
  ...
  study_failed: {
    ...
    description:
      'The engineering study did not complete successfully. Check your input parameters and try again.',
    actions: [
  ...
  network_error: {
    ...
    title: 'Network Error',
    description:
      'A network error occurred while communicating with the server. Check your internet connection.',
    actions: [
  ...
  rate_limited: {
    ...
    actions: [{ label: 'Wait and Retry', action: 'wait_retry' }],
  },
  validation_error: {
    topic: 'input.validation',
    title: 'Input Validation Error',
    description:
      'The data you provided does not meet the required format. Check the fields and try again.',
    actions: [{ label: 'Review Input', action: 'review_input' }],
  },
};
