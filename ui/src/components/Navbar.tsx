...
const DEMO_NOTIFICATIONS: NotificationItem[] = [
  {
    id: '1',
    type: 'info',
    title: 'Welcome to AhmedETAP',
    message: 'Demo mode is active — explore all features without a backend.',
    time: '2m ago',
    read: false,
  },
  {
    id: '2',
    type: 'success',
    title: 'Load Flow Completed',
    message: 'Industrial Plant study finished in 245ms',
    time: '1h ago',
    read: false,
  },
  {
    id: '3',
    type: 'warning',
    title: 'ETAP Worker Offline',
    message: 'Connect to ETAP worker to enable live studies',
    time: '3h ago',
    read: true,
  },
  {
    ...
    message: 'Harmonic Analysis Agent v2.0 deployed',
    time: '5h ago',
    read: true,
  },
];
  ...
  return (
    <header className="flex items-center justify-between px-3 sm:px-4 py-2 bg-[var(--bg-secondary)]/80 backdrop-blur-xl border-b border-[var(--border-primary)]/50 shrink-0 z-[var(--z-navbar)] relative">
      ...
      <div className="flex items-center gap-0.5 shrink-0">
        ...
        <div className="hidden md:block">
          <ToolButton onClick={openHelp} icon={HelpCircle} title="Smart Help (F1)" />
        </div>
