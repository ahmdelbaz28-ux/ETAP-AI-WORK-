  ...
  return (
    <div className="flex flex-col h-screen overflow-hidden bg-[var(--bg-primary)] relative">
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden" aria-hidden="true">
        ...
        <div className="absolute -bottom-60 -right-40 w-[600px] h-[600px] bg-gradient-to-tl from-purple-500/4 via-transparent to-transparent rounded-full blur-3xl animate-aurora" style={{ animationDelay: '-7s', animationDirection: 'reverse' }} />
        <div className="absolute top-1/2 left-1/3 w-[400px] h-[400px] bg-gradient-to-r from-cyan-500/3 via-transparent to-transparent rounded-full blur-3xl animate-aurora" style={{ animationDelay: '-14s' }} />
      </div>
