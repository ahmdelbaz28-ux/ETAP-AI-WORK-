...
const variantStyles: Record<ButtonVariant, string> = {
  primary:
    "bg-brand-600 hover:bg-brand-500 text-white shadow-sm shadow-brand-600/20 hover:shadow-brand-500/30 active:bg-brand-700",
  secondary:
    "bg-[var(--bg-elevated)] hover:bg-[var(--border-primary)] text-[var(--text-secondary)] border border-[var(--border-primary)] active:bg-[var(--border-secondary)]",
  ghost:
    "hover:bg-[var(--bg-elevated)] text-[var(--text-secondary)] active:bg-[var(--border-primary)]",
