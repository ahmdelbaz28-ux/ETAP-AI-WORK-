...
const navItems: NavItem[] = [
  ...
  { to: "/admin/audit-logs", icon: ScrollText, labelKey: "sidebar.auditLogs", section: "system" },
  { to: "/admin/feature-flags", icon: ToggleLeft, labelKey: "sidebar.featureFlags", section: "system" },
  { to: "/integrations", icon: Plug, labelKey: "sidebar.integrations", section: "integration" },
...
// --- Mobile Sidebar Drawer sub-component (extracted from Sidebar to reduce
// its cognitive complexity — the entire mobile drawer with its own nav,
// header, and bottom section now lives in a separate function). ---
