...
function TableTab({ result }: { readonly result: ResultEntry }) {
  ...
  if (rows.length === 0) {
    return (
      <p className="text-xs text-[var(--text-tertiary)] py-4" data-testid="result-viewer-table-empty">
...
function ChartsTab({ result }: { readonly result: ResultEntry }) {
  ...
  if (!hasCharts) {
    return (
      <p className="text-xs text-[var(--text-tertiary)] py-4" data-testid="result-viewer-charts-empty">
...
function DiagramTab({ result }: { readonly result: ResultEntry }) {
  ...
  if (nodes.length === 0) {
    return (
      <p className="text-xs text-[var(--text-tertiary)] py-4" data-testid="result-viewer-diagram-empty">
