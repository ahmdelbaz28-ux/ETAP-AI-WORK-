  ...
  return (
    <div className="bg-[var(--bg-primary)] rounded-lg p-4 border border-[var(--border-primary)]">
      ...
      <svg viewBox="0 0 600 300" className="w-full h-auto" style={{ minHeight: 200 }}>
        ...
        <text x="50" y="130" textAnchor="middle" fill="var(--color-engine-voltage)" fontSize="9">
          1.05 pu
        </text>
        <text x="150" y="90" textAnchor="middle" fill="var(--text-tertiary)" fontSize="9">
          Bus 1 (Slack)
        </text>
        ...
        <line
          ...
          strokeWidth="1.5"
        />
        <text x="365" y="275" textAnchor="middle" fill="var(--color-engine-current)" fontSize="9">
          1.0 + j0.3
        </text>
        <text x="400" y="215" textAnchor="middle" fill="var(--text-tertiary)" fontSize="9">
          Bus 3 (PQ)
        </text>
        ...
        <text x="33" y="276" fill="var(--text-muted)" fontSize="7">
          Generator
        </text>
        <line x1="80" y1="272" x2="95" y2="272" className="one-line-bus" />
        <text x="100" y="276" fill="var(--text-muted)" fontSize="7">
          Bus
        </text>
        <polygon points="140,268 150,268 145,276" className="one-line-load" />
        <text x="155" y="276" fill="var(--text-muted)" fontSize="7">
          Load
        </text>
        <text x="25" y="290" fill="var(--text-muted)" fontSize="7">
          Voltage in pu
        </text>
      </svg>
    </div>
