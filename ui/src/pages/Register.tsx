...
export default function Register() {
  // NOSONAR - S3776: cognitive complexity reduced below 15 by extracting helper components
  ...
  const handleSubmit = useCallback(
    async (e: React.FormEvent) => {
      ...
      try {
        ...
        notify(
          "error",
          `${i18n.language === "ar" ? "فشل إنشاء الحساب" : "Registration failed"}: ${message}`,
        );
      } finally {
        setLoading(false);
      }
        ...
        >
          ...
          <form onSubmit={onSubmit} className="space-y-4">
            ...
            <SubmitButton
              ...
              defaultText={t("auth.createAccountButton")}
            />
          </form>
          <Footer />
        </motion.div>
    ...
    <div className="absolute inset-0 pointer-events-none z-0">
      ...
      >
        ...
        <path
          ...
          strokeDashoffset="0"
          style={{ animation: "gridFlowReg 12s linear infinite" }}
        />
        ...
        <path
          ...
          strokeDashoffset="0"
          style={{ animation: "gridFlowRevReg 10s linear infinite" }}
        />
        ...
        <path
          ...
          strokeDashoffset="0"
          style={{ animation: "gridFlowReg 8s linear infinite" }}
        />
        ...
        <circle r="3.5" fill="#00d4ff" opacity="0.8">
          <animateMotion
            ...
            path="M800,90 L800,180 L400,180 L400,450 L600,450 L600,572"
          />
        </circle>
        ...
        <path
          d="M1000,450 L1000,580"
          stroke="#a78bfa"
          strokeWidth="1.5"
          strokeDasharray="8 8"
          strokeDashoffset="0"
          style={{ animation: "gridFlowRevReg 14s linear infinite" }}
        />
        <rect
          x="993"
          y="495"
