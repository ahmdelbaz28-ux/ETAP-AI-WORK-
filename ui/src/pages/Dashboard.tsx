  ...
  return (
    <div className="flex flex-col items-center gap-1">
      <div className="relative w-12 h-12">
        ...
        <span className="absolute inset-0 flex items-center justify-center text-[10px] font-bold text-[var(--text-primary)] mono-engineering">{pct}%</span>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <CardHeader
            ...
            action={
              <div className="flex items-center gap-3 text-xs text-[var(--text-muted)]">
                <span className="flex items-center gap-1"><span className="w-2 h-2 rounded-full bg-brand-500" /> Requests</span>
        ...
        <Card padding="md">
          <CardHeader
            ...
            action={
              <button onClick={() => navigate('/studies')} className="text-xs text-brand-400 hover:text-brand-300 transition-colors flex items-center gap-1">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <Card padding="md">
          <CardHeader
            ...
            action={
              <button onClick={() => navigate('/assistant')} className="text-xs text-brand-400 hover:text-brand-300 transition-colors flex items-center gap-1">
                {t('dashboard.viewAll')} <ArrowRight className="w-3 h-3" />
              </button>
            }
          />
          <div className="space-y-2 max-h-60 overflow-y-auto pr-1">
            {agents.length > 0 ? agents.map(agent => (
              ...
              <div className="text-center py-6">
                ...
                <p className="text-xs text-[var(--text-muted)] mt-1">Check API key configuration in Settings</p>
              </div>
            )}
          </div>
        </Card>
        ...
        <Card padding="md">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div className="bg-[var(--bg-primary)] rounded-lg p-3 text-center">
              ...
              <span className="text-sm font-bold text-[var(--text-primary)] mono-engineering">{health.engineeringService.latencyMs ?? 'N/A'}ms</span>
            </div>
            <div className="bg-[var(--bg-primary)] rounded-lg p-3 text-center">
