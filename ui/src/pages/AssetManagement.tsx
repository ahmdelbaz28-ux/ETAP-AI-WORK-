...
export default function AssetManagement() {
  ...
  useEffect(() => {
    localStorage.setItem('etap-assets', JSON.stringify(assets));
  }, [assets]);
                    ...
                    card.variant === 'success'
                      ...
                      : card.variant === 'warning'
                        ...
                        : // NOSONAR — S3358: nested ternary; refactor to named variable (tech debt)
                          card.variant === 'danger'
                          ? 'text-red-400'
                          : 'text-[var(--text-tertiary)]', // NOSONAR — S3358: nested ternary; refactor to named variable (tech debt)
                  )}
                >
                  {card.icon}
                </span>
