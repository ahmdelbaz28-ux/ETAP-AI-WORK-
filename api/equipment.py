...
async def _build_equipment_response(
    _db: AsyncSession,  # S1172 param retained for interface consistency  # NOSONAR S1172: parameter is part of interface contract / protocol; removal would break callers
    equipment: Equipment,
) -> EquipmentResponse:
