...
from engine.resilience import CircuitBreaker, get_circuit_breaker
            ...
            with ETAPAutomation(visible=visible) as etap:
                ...
                if not project:
                    return ETAPResult(
                        ...
                        {},
                        [],
                        [f"Failed to open project: {project_path}"],
        ...
        for attempt in range(self.MAX_RETRIES):
            try:
                ...
                if response.status_code == 200:
                    ...
                    logger.warning(
                        "RemoteEtapProvider attempt %d/%d failed: %s",
                        attempt + 1,
                        self.MAX_RETRIES,
                        last_error,
                    )
...
class MockEtapProvider(IEtapProvider):
    ...
    MOCK_RESULTS = {
        ETAPStudyType.LOAD_FLOW: {
            ...
            "branches": {
                "Line1-2": {
                    "active_power_from": 50.2,
                    "reactive_power_from": 10.5,
                    "current": 0.52,
                },
        ...
        ETAPStudyType.SHORT_CIRCUIT: {
            "fault_currents": {
                "Bus1": {
                    "three_phase_ka": 20.5,
                    "line_to_ground_ka": 18.2,
                    "line_to_line_ka": 17.7,
                    "double_line_to_ground_ka": 19.1,
                },
                "Bus2": {
                    "three_phase_ka": 15.3,
                    "line_to_ground_ka": 13.8,
                    "line_to_line_ka": 13.2,
                    "double_line_to_ground_ka": 14.5,
                },
            },
        ...
        ETAPStudyType.ARC_FLASH: {
            "equipment_results": {
                ...
                "SWGR-2": {
                    "incident_energy_cal_cm2": 3.2,
                    "arc_flash_boundary_mm": 600,
                    "ppe_level": "1",
        ...
        ETAPStudyType.HARMONIC_ANALYSIS: {
            ...
            "buses": {
                "Bus1": {
                    "voltage_thd_percent": 2.8,
                    "current_thd_percent": 4.5,
                    "fundamental_voltage_mag": 1.02,
                    "dominant_harmonic_order": 5,
                },
                "Bus2": {
                    "voltage_thd_percent": 3.1,
                    "current_thd_percent": 5.2,
                    "fundamental_voltage_mag": 0.98,
                    "dominant_harmonic_order": 7,
                },
            },
        ...
        ETAPStudyType.OPTIMAL_POWER_FLOW: {
            ...
            "generators": {
                "Gen1": {
                    "active_power_mw": 47.5,
                    "reactive_power_mvar": 10.5,
                    "cost_per_hour": 135.0,
                },
                "Gen2": {
                    "active_power_mw": 95.0,
                    "reactive_power_mvar": 21.0,
                    "cost_per_hour": 270.0,
                },
            },
        ...
        ETAPStudyType.MOTOR_STARTING: {
            ...
            "motors": {
                "Motor1": {
                    ...
                    "acceleration_time_sec": 2.5,
                    "min_voltage_during_start_pu": 0.75,
                    "speed_at_end_of_start_percent": 100.0,
                },
                "Motor2": {
                    "starting_current_multiplier": 5.5,
                    "acceleration_time_sec": 3.1,
                    "min_voltage_during_start_pu": 0.82,
                    "speed_at_end_of_start_percent": 100.0,
                },
            },
            "voltage_dip_profile": {"max_dip_percent": 15.0, "recovery_time_sec": 1.2},
    ...
    def execute_study(
        ...
        mock_data = copy.deepcopy(self.MOCK_RESULTS.get(study_type, {}))
