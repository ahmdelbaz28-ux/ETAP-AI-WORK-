...
def _has_undirected_loop(adj: dict[str, set[str]]) -> tuple[bool, list[str]]:  # NOSONAR: cognitive complexity; scheduled for refactoring sprint (extract helpers / early returns)
    """
