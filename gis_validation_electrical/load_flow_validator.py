...
def _compute_deterministic_voltages(model: ElectricalModel) -> dict[str, float]:  # NOSONAR: cognitive complexity; scheduled for refactoring sprint (extract helpers / early returns)
    """
