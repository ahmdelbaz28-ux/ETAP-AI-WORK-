...
def export_power_system_data():
    ...
    power_data = {
        ...
        "devices": [
            {"id": "ups_001", "status": "online", "voltage": 230.5, "current": 12.3, "power_factor": 0.95},
            {"id": "redundancy_001", "status": "active", "load_percentage": 75.2, "capacity": "2MW"},
    ...
    with open(csv_path, 'w', newline='') as csvfile:
        fieldnames = ['id', 'status', 'voltage', 'current', 'power_factor', 'load_percentage', 
                     'capacity', 'temperature', 'oil_level', 'current_flow', 'rated_current']
