...
class RBACEngine:
    ...
    def has_permission(
        self, user_id: str, required_permission: str, node_context: Optional[str] = None
    ) -> bool:
    ...
    def has_role(
        self, user_id: str, required_role: str, node_context: Optional[str] = None
    ) -> bool:
    ...
    def is_authorized(
        self, user_id: str, required_permissions: List[str], node_context: Optional[str] = None
    ) -> bool:
...
class PermissionChecker:
    ...
    def check_method_access(
        self, user_id: str, method: str, node_context: Optional[str] = None
    ) -> tuple[bool, str]:
        """
    ...
    def check_resource_access(
        self, user_id: str, resource: str, action: str, node_context: Optional[str] = None
    ) -> tuple[bool, str]:
        """
    ...
    def get_user_capabilities(
        self, user_id: str, node_context: Optional[str] = None
    ) -> Dict[str, Any]:
